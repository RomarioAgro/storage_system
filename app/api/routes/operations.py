...
def confirm_fill(
    ...
    return OperationService.confirm_fill(db, session_id=session_id, comment=payload.comment)
...
def confirm_take(
    ...
    return OperationService.confirm_take(db, session_id=session_id, comment=payload.comment)
...
def complete_open_only(session_id: int, db: Session = Depends(get_db)):
    return OperationService.complete_open_only(db, session_id=session_id)
...
def confirm_inventory(
    ...
    return OperationService.confirm_inventory(db, session_id=session_id, comment=payload.comment)
